//
//  RNSelectCityTableViewController.swift
//  HoyoServicer
//
...
class RNSelectCityTableViewController: UITableViewController {
    
    internal var backClosure: ProvinceCallBack
    internal var selectedProvince: String
    ...
    init(closure: @escaping ProvinceCallBack, province: String){
