//
//  RNSelectTownTableViewController.swift
//  HoyoServicer
//
...
class RNSelectTownTableViewController: UITableViewController {
    
    
    internal var backClosure: ProvinceCallBack
    internal var selectedCity: String
    
    fileprivate lazy var dataSource = {
        return [String]()
    }()
    
    init(closure: @escaping ProvinceCallBack, city: String){
