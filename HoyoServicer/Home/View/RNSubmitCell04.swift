...
class RNSubmitCell04: SubmitCell{
    ...
    // 退货 View
    @IBOutlet weak var returnGoodsview: UIView! // 退货 View
    @IBOutlet weak var returnTextField: UITextField! // 退货原因 tag=114
    
    @IBOutlet weak var returnViewHeightConstaint: NSLayoutConstraint! // 根据情况对高度约束进行至0
...
extension RNSubmitCell04: UITextFieldDelegate{
...
extension RNSubmitCell04: XLPhotoBrowserDatasource{
