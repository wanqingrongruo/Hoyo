...
//        let achieve = RNAchievementViewController()
//        achieve.delegate = self
       ...
       // MBProgressHUD.showHUDAddedTo(self.view, animated: true)
        ...
        User.GetPerRankDetails(type!, pageindex: "1", pageSize: "20", success: { (dataArr) in
            ...
            if dataArr.isEmpty{
                ...
                weakSelf?.tableViewDisplayWithMsg("暂时没有团队排名数据", ifNecessagryForRowCount: dataArr.count)
...
//        
//        if (type! as NSString).isEqualToString("0") {
//           // type = "3"
//        }else{
//            type = "3"
//        }
...
//        if (type! as NSString).isEqualToString("3") {
//           // type = "3"
//        }else{
//            type = "0"
//        }
...
extension RNTodayViewController:UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        tableViewDisplayWithMsg("暂时没有团队排名数据", ifNecessagryForRowCount: dataSource.count)
...
// MARK: - RNAchievementViewControllerDelegate

extension RNTodayViewController: RNAchievementViewControllerDelegate{
