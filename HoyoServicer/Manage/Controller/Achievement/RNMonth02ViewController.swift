//
//  RNMonth02ViewController.swift
//  HoyoServicer
//
//  Created by 婉卿容若 on 16/7/20.
...
class RNMonth02ViewController: UIViewController {
    ...
    func downFirstData() {
        ...
        User.GetPerRankDetails("4", pageindex: "1", pageSize: "10", success: { (dataArr) in
...
extension RNMonth02ViewController{
...
extension RNMonth02ViewController:UITableViewDelegate,UITableViewDataSource{
