...
class RNGroupDetailViewController: UIViewController {
...
extension RNGroupDetailViewController: TBEmptyDataSetDataSource, TBEmptyDataSetDelegate {
    ...
    func descriptionForEmptyDataSet(in scrollView: UIScrollView) -> NSAttributedString? {
        let description = "未获取到小组详情, 请确认网络是否畅通"
        var attributes: [String: Any]?
...
extension RNGroupDetailViewController {
    ...
    func downloadData() {
        ...
        User.GetGroupDetails(teamId: groupID, success: { (dataArray) in
