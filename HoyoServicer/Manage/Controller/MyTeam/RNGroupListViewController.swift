...
class RNGroupListViewController: UIViewController {
...
extension RNGroupListViewController: TBEmptyDataSetDataSource, TBEmptyDataSetDelegate {
    ...
    func descriptionForEmptyDataSet(in scrollView: UIScrollView) -> NSAttributedString? {
        let description = "该团队尚无小组,请让工程师创建小组"
        var attributes: [String: Any]?
...
extension RNGroupListViewController {
    ...
    func downloadData() {
        ...
        User.GetGroupListInTeam(groupId: groupId, success: { (dataArray) in
